...
if (isFavorite === true) {
    console.log("This is my favorite food...and it has a lot protein!");
};
isFavorite;
...
var shouldOrderMore = true;
  if (shouldOrderMore < 20) {
   console.log("I should order more!")
};
...
// vegetables, represented by their names as Strings.
 ...
 var vegetables = [
  "cucumbers", "carrots", "lettuce", "spinach", "greens"
 ];
...
// different fruits.
 ...
 var fruits = [
  "apples", "oranges", "cherry", "mangoes", "dates", "cranberry", "plumbs"
 ];
